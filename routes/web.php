...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('jurusan')->name('jurusan.')->group(function () {
        Route::get('/export-csv',   [JurusanController::class, 'exportCsv'])->name('export-csv');
        Route::get('/export-excel', [JurusanController::class, 'exportExcel'])->name('export-excel');
        Route::get('/print',        [JurusanController::class, 'print'])->name('print');
    ...
    Route::prefix('mahasiswa')->name('mahasiswa.')->group(function () {
        Route::get('/export-csv',   [MahasiswaController::class, 'exportCsv'])->name('export-csv');
        Route::get('/export-excel', [MahasiswaController::class, 'exportExcel'])->name('export-excel');
        Route::get('/print',        [MahasiswaController::class, 'print'])->name('print');
    ...
    Route::prefix('matakuliah')->name('matakuliah.')->group(function () {
        Route::get('/export-csv',   [MatakuliahController::class, 'exportCsv'])->name('export-csv');
        Route::get('/export-excel', [MatakuliahController::class, 'exportExcel'])->name('export-excel');
        Route::get('/print',        [MatakuliahController::class, 'print'])->name('print');
